# GitHub Actions OIDC: a deploy role GitHub can assume without static AWS keys.
# Scope the trust to this repo; the permissions below are pilot-broad (tighten for prod).
...
# Pilot deploy permissions: push to ECR + update the ECS service.
